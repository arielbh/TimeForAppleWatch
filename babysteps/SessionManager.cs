...
#endif
{
	public sealed class SessionManager : NSObject, IWCSessionDelegate
	{
		// Setup is converted from https://www.natashatherobot.com/watchconnectivity-say-hello-to-wcsession/ 
		// with some extra bits
		private static readonly SessionManager sharedManager = new SessionManager();
		...
		private SessionManager() : base() { }

		public static SessionManager SharedManager
		{
			get
			{
